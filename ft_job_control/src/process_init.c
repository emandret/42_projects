...
static t_process *init_process(const char *xpath, t_builtin builtin, char *const *argv)
{
    t_process *p;
...
t_process *add_process(t_job *j, const char *xpath, t_builtin builtin, char *const *argv)
{
    t_process *p;
